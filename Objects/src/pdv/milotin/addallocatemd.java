...
anywheresoftware.b4a.keywords.Common.LogImpl("67536647",_strselectcategory,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("67864335",anywheresoftware.b4a.keywords.Common.NumberFormat(_percentage,(int) (1),(int) (3)),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("66815750","HASH:"+BA.ObjectToString(mostCurrent._kvs._get("AuditTransactionHash")),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("67667717","Donate :"+BA.ObjectToString(mostCurrent._kvs._get("DonateAmount")),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("66946823",_jsonstring,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("66946859","Transaction Hash: "+_transactionhash,0);
 //BA.debugLineNum = 209;BA.debugLine="Log(\"Nonce: \" & nonce)";
anywheresoftware.b4a.keywords.Common.LogImpl("66946860","Nonce: "+BA.NumberToString(_nonce),0);
 //BA.debugLineNum = 210;BA.debugLine="Log(\"From: \" & from)";
anywheresoftware.b4a.keywords.Common.LogImpl("66946861","From: "+_from,0);
 //BA.debugLineNum = 211;BA.debugLine="Log(\"Status: \" & responseStatus)";
anywheresoftware.b4a.keywords.Common.LogImpl("66946862","Status: "+_responsestatus,0);
 //BA.debugLineNum = 212;BA.debugLine="Log(\"Receipt: \" & receipt)";
anywheresoftware.b4a.keywords.Common.LogImpl("66946863","Receipt: "+BA.ObjectToString(_receipt),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("66946887",BA.ObjectToString(_metadata.Get((Object)("project"))),0);
 //BA.debugLineNum = 237;BA.debugLine="Log(metadata.Get(\"fund\"))";
anywheresoftware.b4a.keywords.Common.LogImpl("66946888",BA.ObjectToString(_metadata.Get((Object)("fund"))),0);
 //BA.debugLineNum = 238;BA.debugLine="Log(metadata.Get(\"progress\"))";
anywheresoftware.b4a.keywords.Common.LogImpl("66946889",BA.ObjectToString(_metadata.Get((Object)("progress"))),0);
 //BA.debugLineNum = 239;BA.debugLine="Log(metadata.Get(\"status\"))";
anywheresoftware.b4a.keywords.Common.LogImpl("66946890",BA.ObjectToString(_metadata.Get((Object)("status"))),0);
 //BA.debugLineNum = 240;BA.debugLine="Log(metadata.Get(\"project_wallet\"))";
anywheresoftware.b4a.keywords.Common.LogImpl("66946891",BA.ObjectToString(_metadata.Get((Object)("project_wallet"))),0);
 //BA.debugLineNum = 242;BA.debugLine="GetAuditCategory";
_getauditcategory();
 }else {
 //BA.debugLineNum = 245;BA.debugLine="Log(\"Error: \" & Job.ErrorMessage)";
anywheresoftware.b4a.keywords.Common.LogImpl("66946896","Error: "+_job._errormessage /*String*/ ,0);
 };
 }else {
 //BA.debugLineNum = 250;BA.debugLine="Log(\"Error: \" & Job.ErrorMessage)";
anywheresoftware.b4a.keywords.Common.LogImpl("66946901","Error: "+_job._errormessage /*String*/ ,0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("66881309",_json.ToString(),0);
