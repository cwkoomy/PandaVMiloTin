...
public class cameraexclass extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "pdv.milotin.cameraexclass");
            if (htSubs == null) {
...
__c.LogImpl("35701636","AutoFocus error.",0);
 };
...
__c.LogImpl("33801096","success = false, "+BA.ObjectToString(__c.LastException(ba)),0);
 };
...
__c.LogImpl("34456454",BA.ObjectToString(__c.LastException(ba)),0);
 };
 //BA.debugLineNum = 144;BA.debugLine="End Sub";
return "";
}
public pdv.milotin.cameraexclass._camerainfoandid  _findcamera(boolean _frontcamera) throws Exception{
...
public pdv.milotin.cameraexclass._camerasize  _getpicturesize() throws Exception{
...
public pdv.milotin.cameraexclass._camerasize  _getpreviewsize() throws Exception{
pdv.milotin.cameraexclass._camerasize _cs = null;
...
_fm = (anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_r.RunMethod("getSupportedFocusModes")));
...
public pdv.milotin.cameraexclass._camerasize[]  _getsupportedpicturessizes() throws Exception{
...
__c.LogImpl("35373959","Continuous focus mode is not available",0);
 };
...
__c.LogImpl("33735568",BA.NumberToString(_previewresult),0);
 };
