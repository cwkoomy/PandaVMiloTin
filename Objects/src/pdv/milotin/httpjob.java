...
public class httpjob extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "pdv.milotin.httpjob");
            if (htSubs == null) {
...
__c.LogImpl("99895941",("Invalid link: "+__c.SmartStringFormatter("",(Object)(_link))+""),0);
...
__c.LogImpl("99961477",("Invalid link: "+__c.SmartStringFormatter("",(Object)(_link))+""),0);
...
__c.LogImpl("99437189",("Invalid link: "+__c.SmartStringFormatter("",(Object)(_link))+""),0);
...
__c.LogImpl("99371660",("Invalid link: "+__c.SmartStringFormatter("",(Object)(_link))+""),0);
...
__c.LogImpl("99633800","Cannot send files from the assets folder.",0);
