...
anywheresoftware.b4a.keywords.Common.LogImpl("55963781",_jsonstring,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("55963799","Transaction Hash: "+_transactionhash,0);
RDebugUtils.currentLine=5963800;
 //BA.debugLineNum = 5963800;BA.debugLine="Log(\"Nonce: \" & nonce)";
anywheresoftware.b4a.keywords.Common.LogImpl("55963800","Nonce: "+BA.NumberToString(_nonce),0);
RDebugUtils.currentLine=5963801;
 //BA.debugLineNum = 5963801;BA.debugLine="Log(\"From: \" & from)";
anywheresoftware.b4a.keywords.Common.LogImpl("55963801","From: "+_from,0);
RDebugUtils.currentLine=5963802;
 //BA.debugLineNum = 5963802;BA.debugLine="Log(\"Status: \" & responseStatus)";
anywheresoftware.b4a.keywords.Common.LogImpl("55963802","Status: "+_responsestatus,0);
RDebugUtils.currentLine=5963803;
 //BA.debugLineNum = 5963803;BA.debugLine="Log(\"Receipt: \" & receipt)";
anywheresoftware.b4a.keywords.Common.LogImpl("55963803","Receipt: "+BA.ObjectToString(_receipt),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("55963809","Failed to post the job",0);
 };
 }else {
RDebugUtils.currentLine=5963813;
 //BA.debugLineNum = 5963813;BA.debugLine="Log(\"Error: \" & Job.ErrorMessage)";
anywheresoftware.b4a.keywords.Common.LogImpl("55963813","Error: "+_job._errormessage /*String*/ ,0);
 };
 }else {
RDebugUtils.currentLine=5963817;
 //BA.debugLineNum = 5963817;BA.debugLine="Log(\"Error: \" & Job.ErrorMessage)";
anywheresoftware.b4a.keywords.Common.LogImpl("55963817","Error: "+_job._errormessage /*String*/ ,0);
 };
