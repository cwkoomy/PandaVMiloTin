...
views.get("imgadd").vw.setWidth((int)((30d * scale)));
views.get("imgadd").vw.setHeight((int)((30d * scale)));
views.get("imgadd").vw.setLeft((int)((97d / 100 * width) - (views.get("imgadd").vw.getWidth())));
views.get("imgadd").vw.setTop((int)((views.get("lbltop").vw.getTop() + views.get("lbltop").vw.getHeight()/2) - (views.get("imgadd").vw.getHeight() / 2)));
