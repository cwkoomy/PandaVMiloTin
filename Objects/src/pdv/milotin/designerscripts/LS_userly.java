...
views.get("imguseravatar").vw.setLeft((int)((views.get("pnframe2").vw.getLeft())+(10d / 100 * width)));
views.get("imguseravatar").vw.setTop((int)((views.get("pnframe2").vw.getTop()) - (views.get("imguseravatar").vw.getHeight() / 2)));
views.get("lblfullname").vw.setWidth((int)((70d / 100 * width)));
...
views.get("pnfullname").vw.setWidth((int)((70d / 100 * width)));
...
views.get("txtfullname").vw.setWidth((int)((50d / 100 * width)));
