...
views.get("btnlogin").vw.setHeight((int)((50d * scale)));
...
views.get("btnregister").vw.setWidth((int)((75d / 100 * width)));
views.get("btnregister").vw.setHeight((int)((50d * scale)));
views.get("btnregister").vw.setLeft((int)((50d / 100 * width) - (views.get("btnregister").vw.getWidth() / 2)));
views.get("btnregister").vw.setTop((int)((views.get("btnlogin").vw.getTop() + views.get("btnlogin").vw.getHeight())));
views.get("lblforgotpassword").vw.setWidth((int)((75d / 100 * width)));
views.get("lblforgotpassword").vw.setTop((int)((98d / 100 * height) - (views.get("lblforgotpassword").vw.getHeight())));
...
views.get("lbltopic").vw.setWidth((int)((75d / 100 * width)));
...
views.get("lbltopic").vw.setTop((int)(+(20d / 100 * height)));
