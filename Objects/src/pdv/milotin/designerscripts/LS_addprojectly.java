...
views.get("pnframe2").vw.setHeight((int)((80d / 100 * height)));
...
views.get("btnprojectsubmit").vw.setTop((int)((views.get("pnframe2").vw.getTop() + views.get("pnframe2").vw.getHeight())-(5d / 100 * height) - (views.get("btnprojectsubmit").vw.getHeight())));
views.get("lblbottom").vw.setWidth((int)((100d / 100 * width)));
views.get("lblbottom").vw.setHeight((int)((80d * scale)));
views.get("lblbottom").vw.setLeft((int)((views.get("pnframe2").vw.getTop() + views.get("pnframe2").vw.getHeight())-(5d / 100 * height) - (views.get("lblbottom").vw.getWidth() / 2)));
