...
views.get("pnlistview2").vw.setWidth((int)((90d / 100 * width)));
views.get("pnlistview2").vw.setHeight((int)((69d / 100 * height)));
views.get("pnlistview2").vw.setLeft((int)((50d / 100 * width) - (views.get("pnlistview2").vw.getWidth() / 2)));
views.get("pnlistview2").vw.setTop((int)((views.get("pnframe2").vw.getTop() + views.get("pnframe2").vw.getHeight())-(2d / 100 * height)));
views.get("clvhistory").vw.setWidth((int)((90d / 100 * width)));
views.get("clvhistory").vw.setHeight((int)((67d / 100 * height)));
views.get("clvhistory").vw.setLeft((int)((0d / 100 * width)));
views.get("clvhistory").vw.setTop((int)((0d / 100 * height)));
...
views.get("lblline5").vw.setWidth((int)((90d / 100 * width)));
views.get("lblline5").vw.setHeight((int)((20d * scale)));
views.get("lblline5").vw.setLeft((int)((50d / 100 * width) - (views.get("lblline5").vw.getWidth() / 2)));
views.get("lblline5").vw.setTop((int)((views.get("lblusertitle").vw.getTop() + views.get("lblusertitle").vw.getHeight())));
