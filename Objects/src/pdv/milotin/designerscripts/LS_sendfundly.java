...
views.get("imgbtc").vw.setLeft((int)((views.get("imgmaschain").vw.getLeft() + views.get("imgmaschain").vw.getWidth())+(1d / 100 * width)));
...
views.get("imgfpx").vw.setLeft((int)((views.get("imgbtc").vw.getLeft() + views.get("imgbtc").vw.getWidth())+(1d / 100 * width)));
...
//BA.debugLineNum = 192;BA.debugLine="imgClose2.Width = 25dip"[SendFundLy/General script]
views.get("imgclose2").vw.setWidth((int)((25d * scale)));
//BA.debugLineNum = 193;BA.debugLine="imgClose2.Height = imgClose.Width"[SendFundLy/General script]
views.get("imgclose2").vw.setHeight((int)((views.get("imgclose").vw.getWidth())));
//BA.debugLineNum = 194;BA.debugLine="imgClose2.Right = lblTittle3.Right"[SendFundLy/General script]
...
//BA.debugLineNum = 195;BA.debugLine="imgClose2.VerticalCenter = lblTittle3.VerticalCenter"[SendFundLy/General script]
...
//BA.debugLineNum = 197;BA.debugLine="lblLine3.Width = 90%x"[SendFundLy/General script]
views.get("lblline3").vw.setWidth((int)((90d / 100 * width)));
//BA.debugLineNum = 198;BA.debugLine="lblLine3.Height = 20dip"[SendFundLy/General script]
views.get("lblline3").vw.setHeight((int)((20d * scale)));
//BA.debugLineNum = 199;BA.debugLine="lblLine3.Left = 0%x"[SendFundLy/General script]
views.get("lblline3").vw.setLeft((int)((0d / 100 * width)));
//BA.debugLineNum = 200;BA.debugLine="lblLine3.Top = lblTittle3.Bottom"[SendFundLy/General script]
views.get("lblline3").vw.setTop((int)((views.get("lbltittle3").vw.getTop() + views.get("lbltittle3").vw.getHeight())));
//BA.debugLineNum = 202;BA.debugLine="imgStatus.Width = 80dip"[SendFundLy/General script]
views.get("imgstatus").vw.setWidth((int)((80d * scale)));
//BA.debugLineNum = 203;BA.debugLine="imgStatus.Height = 80dip"[SendFundLy/General script]
views.get("imgstatus").vw.setHeight((int)((80d * scale)));
//BA.debugLineNum = 204;BA.debugLine="imgStatus.HorizontalCenter = lblTittle3.HorizontalCenter"[SendFundLy/General script]
...
//BA.debugLineNum = 205;BA.debugLine="imgStatus.Top = lblLine3.Bottom +1%y"[SendFundLy/General script]
views.get("imgstatus").vw.setTop((int)((views.get("lblline3").vw.getTop() + views.get("lblline3").vw.getHeight())+(1d / 100 * height)));
//BA.debugLineNum = 207;BA.debugLine="lblStatus.Width = lblTittle3.Width"[SendFundLy/General script]
views.get("lblstatus").vw.setWidth((int)((views.get("lbltittle3").vw.getWidth())));
//BA.debugLineNum = 208;BA.debugLine="lblStatus.Height = lblTittle3.Height"[SendFundLy/General script]
views.get("lblstatus").vw.setHeight((int)((views.get("lbltittle3").vw.getHeight())));
//BA.debugLineNum = 209;BA.debugLine="lblStatus.Left = lblTittle3.Left"[SendFundLy/General script]
