...
anywheresoftware.b4a.keywords.Common.LogImpl("31703951",BA.ObjectToString(mostCurrent._kvs._get("AuditID")),0);
...
public static boolean  _activity_keypress(int _keycode) throws Exception{
 ...
 //BA.debugLineNum = 275;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK Then";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 276;BA.debugLine="kvs.Put(\"ProjectWallet\",\"\")";
...
public static String  _activity_resume() throws Exception{
 //BA.debugLineNum = 247;BA.debugLine="Sub Activity_Resume";
 //BA.debugLineNum = 249;BA.debugLine="End Sub";
return "";
}
public static String  _btnclose_click() throws Exception{
 //BA.debugLineNum = 315;BA.debugLine="Private Sub btnClose_Click";
 //BA.debugLineNum = 317;BA.debugLine="If kvs.Get(\"Status\") = \"success\" Then";
if ((mostCurrent._kvs._get("Status")).equals((Object)("success"))) { 
 //BA.debugLineNum = 318;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 }else {
 //BA.debugLineNum = 320;BA.debugLine="pnStatus.Visible = False";
mostCurrent._pnstatus.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 321;BA.debugLine="pnConfirmation.Visible = False";
mostCurrent._pnconfirmation.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 322;BA.debugLine="btnNext.Visible = True";
...
public static String  _btnnext_click() throws Exception{
 //BA.debugLineNum = 284;BA.debugLine="Private Sub btnNext_Click";
 //BA.debugLineNum = 285;BA.debugLine="pnBlackTransparent.Visible = True";
mostCurrent._pnblacktransparent.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 286;BA.debugLine="pnConfirmation.Visible = True";
mostCurrent._pnconfirmation.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 287;BA.debugLine="btnNext.Visible = False";
mostCurrent._btnnext.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 288;BA.debugLine="lblDonateAmount.Text = txtDonateAmount.Text";
mostCurrent._lbldonateamount.setText(BA.ObjectToCharSequence(mostCurrent._txtdonateamount.getText()));
 //BA.debugLineNum = 290;BA.debugLine="kvs.Put(\"DonateAmount\",lblDonateAmount.Text)";
mostCurrent._kvs._put("DonateAmount",(Object)(mostCurrent._lbldonateamount.getText()));
 //BA.debugLineNum = 291;BA.debugLine="Log(kvs.Get(\"DonateAmount\"))";
anywheresoftware.b4a.keywords.Common.LogImpl("32490375",BA.ObjectToString(mostCurrent._kvs._get("DonateAmount")),0);
 //BA.debugLineNum = 292;BA.debugLine="End Sub";
return "";
}
public static String  _btnsend_click() throws Exception{
 //BA.debugLineNum = 299;BA.debugLine="Private Sub btnSend_Click";
 //BA.debugLineNum = 300;BA.debugLine="PostTransaction";
_posttransaction();
...
double _percentage = 0;
 //BA.debugLineNum = 326;BA.debugLine="Sub CalculatePercentage(part As Double, total As D";
 //BA.debugLineNum = 327;BA.debugLine="Dim percentage As Double";
_percentage = 0;
 //BA.debugLineNum = 328;BA.debugLine="percentage = (part / total) * 100";
_percentage = (_part/(double)_total)*100;
 //BA.debugLineNum = 329;BA.debugLine="If percentage > 100 Then";
if (_percentage>100) { 
 //BA.debugLineNum = 330;BA.debugLine="cpBar2.Value = \"100\"";
mostCurrent._cpbar2._setvalue /*float*/ ((float)(Double.parseDouble("100")));
 //BA.debugLineNum = 331;BA.debugLine="lblProjectProgress2.TextColor = Colors.RGB(5,206";
mostCurrent._lblprojectprogress2.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (5),(int) (206),(int) (46)));
 //BA.debugLineNum = 332;BA.debugLine="lblProjectProgress2.Text = \"Fundraising complete";
mostCurrent._lblprojectprogress2.setText(BA.ObjectToCharSequence("Fundraising complete"));
 }else {
 //BA.debugLineNum = 334;BA.debugLine="cpBar2.Value = NumberFormat(percentage, 1, 3)";
mostCurrent._cpbar2._setvalue /*float*/ ((float)(Double.parseDouble(anywheresoftware.b4a.keywords.Common.NumberFormat(_percentage,(int) (1),(int) (3)))));
 //BA.debugLineNum = 335;BA.debugLine="lblProjectProgress2.TextColor = Colors.RGB(254,17";
mostCurrent._lblprojectprogress2.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (254),(int) (171),(int) (43)));
 //BA.debugLineNum = 336;BA.debugLine="lblProjectProgress2.Text = \"Fundraising in progre";
mostCurrent._lblprojectprogress2.setText(BA.ObjectToCharSequence("Fundraising in progress"));
 };
 //BA.debugLineNum = 339;BA.debugLine="Log(NumberFormat(percentage, 1, 3))";
anywheresoftware.b4a.keywords.Common.LogImpl("32883597",anywheresoftware.b4a.keywords.Common.NumberFormat(_percentage,(int) (1),(int) (3)),0);
...
String _url = "";
 //BA.debugLineNum = 97;BA.debugLine="Sub CheckWalletBalance";
 //BA.debugLineNum = 99;BA.debugLine="Dim JobCheckWalletBalance As HttpJob";
_jobcheckwalletbalance = new pdv.milotin.httpjob();
 //BA.debugLineNum = 100;BA.debugLine="JobCheckWalletBalance.Initialize(\"JobCheckWalletB";
_jobcheckwalletbalance._initialize /*String*/ (processBA,"JobCheckWalletBalance",sendfundmd.getObject());
 //BA.debugLineNum = 103;BA.debugLine="Dim json As JSONGenerator";
_json = new anywheresoftware.b4a.objects.collections.JSONParser.JSONGenerator();
 //BA.debugLineNum = 104;BA.debugLine="Dim data As Map";
_data = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 105;BA.debugLine="data.Initialize";
_data.Initialize();
 //BA.debugLineNum = 106;BA.debugLine="data.Put(\"wallet_address\", kvs.Get(\"ProjectWallet";
_data.Put((Object)("wallet_address"),mostCurrent._kvs._get("ProjectWallet"));
 //BA.debugLineNum = 107;BA.debugLine="data.Put(\"contract_address\", kvs.Get(\"token-contr";
_data.Put((Object)("contract_address"),mostCurrent._kvs._get("token-contract"));
 //BA.debugLineNum = 108;BA.debugLine="json.Initialize(data)";
_json.Initialize(_data);
 //BA.debugLineNum = 111;BA.debugLine="Dim url As String = \"https://service-testnet.masc";
_url = "https://service-testnet.maschain.com/api/token/balance/";
 //BA.debugLineNum = 112;BA.debugLine="JobCheckWalletBalance.PostString(url, json.ToStri";
_jobcheckwalletbalance._poststring /*String*/ (_url,_json.ToString());
 //BA.debugLineNum = 113;BA.debugLine="JobCheckWalletBalance.GetRequest.SetContentType(\"";
_jobcheckwalletbalance._getrequest /*anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest*/ ().SetContentType("application/json");
 //BA.debugLineNum = 114;BA.debugLine="JobCheckWalletBalance.GetRequest.SetHeader(\"clien";
...
_url = "https://service-testnet.maschain.com/api/audit/audit/"+BA.ObjectToString(mostCurrent._kvs._get("AuditID"));
 //BA.debugLineNum = 90;BA.debugLine="JobGetAuditByID.Download(url)";
_jobgetauditbyid._download /*String*/ (_url);
 //BA.debugLineNum = 91;BA.debugLine="JobGetAuditByID.GetRequest.SetHeader(\"client_id\",";
_jobgetauditbyid._getrequest /*anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest*/ ().SetHeader("client_id",BA.ObjectToString(mostCurrent._kvs._get("client_id")));
 //BA.debugLineNum = 92;BA.debugLine="JobGetAuditByID.GetRequest.SetHeader(\"client_secr";
...
public static String  _imgback_click() throws Exception{
 //BA.debugLineNum = 294;BA.debugLine="Private Sub imgBack_Click";
 //BA.debugLineNum = 295;BA.debugLine="kvs.Put(\"ProjectWallet\",\"\")";
mostCurrent._kvs._put("ProjectWallet",(Object)(""));
...
public static String  _imgclose_click() throws Exception{
 //BA.debugLineNum = 303;BA.debugLine="Private Sub imgClose_Click";
 //BA.debugLineNum = 304;BA.debugLine="pnBlackTransparent.Visible = False";
mostCurrent._pnblacktransparent.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 305;BA.debugLine="pnConfirmation.Visible = False";
mostCurrent._pnconfirmation.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 306;BA.debugLine="btnNext.Visible = True";
mostCurrent._btnnext.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 307;BA.debugLine="kvs.Put(\"DonateAmount\",\"\")";
mostCurrent._kvs._put("DonateAmount",(Object)(""));
 //BA.debugLineNum = 308;BA.debugLine="Log(\"Donate :\" & kvs.Get(\"DonateAmount\"))";
anywheresoftware.b4a.keywords.Common.LogImpl("32686981","Donate :"+BA.ObjectToString(mostCurrent._kvs._get("DonateAmount")),0);
 //BA.debugLineNum = 309;BA.debugLine="End Sub";
return "";
}
public static String  _imgclose2_click() throws Exception{
 //BA.debugLineNum = 311;BA.debugLine="Private Sub imgClose2_Click";
...
if (_job._success /*boolean*/ ) { 
 //BA.debugLineNum = 147;BA.debugLine="Dim jsonString As String = Job.GetString";
_jsonstring = _job._getstring /*String*/ ();
 //BA.debugLineNum = 148;BA.debugLine="Log(jsonString)";
anywheresoftware.b4a.keywords.Common.LogImpl("31966087",_jsonstring,0);
 //BA.debugLineNum = 150;BA.debugLine="Dim parser As JSONParser";
_parser = new anywheresoftware.b4a.objects.collections.JSONParser();
 //BA.debugLineNum = 151;BA.debugLine="parser.Initialize(jsonString)";
_parser.Initialize(_jsonstring);
 //BA.debugLineNum = 153;BA.debugLine="If Job.JobName = \"JobGetAuditByID\" Then";
...
_root = _parser.NextObject();
 //BA.debugLineNum = 158;BA.debugLine="Dim result As Map = root.Get(\"result\")";
...
_result = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_root.Get((Object)("result"))));
 //BA.debugLineNum = 161;BA.debugLine="Dim metadataString As String = result.Get(\"meta";
_metadatastring = BA.ObjectToString(_result.Get((Object)("metadata")));
 //BA.debugLineNum = 164;BA.debugLine="Dim metadataParser As JSONParser";
_metadataparser = new anywheresoftware.b4a.objects.collections.JSONParser();
 //BA.debugLineNum = 165;BA.debugLine="metadataParser.Initialize(metadataString)";
_metadataparser.Initialize(_metadatastring);
 //BA.debugLineNum = 166;BA.debugLine="Dim metadata As Map = metadataParser.NextObject";
_metadata = new anywheresoftware.b4a.objects.collections.Map();
_metadata = _metadataparser.NextObject();
 //BA.debugLineNum = 170;BA.debugLine="lblProjectTittle.Text = metadata.Get(\"project\")";
mostCurrent._lblprojecttittle.setText(BA.ObjectToCharSequence(_metadata.Get((Object)("project"))));
 //BA.debugLineNum = 172;BA.debugLine="kvs.Put(\"metadataFund\",metadata.Get(\"fund\"))";
mostCurrent._kvs._put("metadataFund",_metadata.Get((Object)("fund")));
 //BA.debugLineNum = 174;BA.debugLine="metadata.Get(\"status\")";
_metadata.Get((Object)("status"));
 //BA.debugLineNum = 177;BA.debugLine="Log(metadata.Get(\"project\"))";
anywheresoftware.b4a.keywords.Common.LogImpl("31966116",BA.ObjectToString(_metadata.Get((Object)("project"))),0);
 //BA.debugLineNum = 178;BA.debugLine="Log(metadata.Get(\"fund\"))";
anywheresoftware.b4a.keywords.Common.LogImpl("31966117",BA.ObjectToString(_metadata.Get((Object)("fund"))),0);
 //BA.debugLineNum = 179;BA.debugLine="Log(metadata.Get(\"progress\"))";
anywheresoftware.b4a.keywords.Common.LogImpl("31966118",BA.ObjectToString(_metadata.Get((Object)("progress"))),0);
 //BA.debugLineNum = 180;BA.debugLine="Log(metadata.Get(\"status\"))";
anywheresoftware.b4a.keywords.Common.LogImpl("31966119",BA.ObjectToString(_metadata.Get((Object)("status"))),0);
 //BA.debugLineNum = 181;BA.debugLine="Log(metadata.Get(\"project_wallet\"))";
anywheresoftware.b4a.keywords.Common.LogImpl("31966120",BA.ObjectToString(_metadata.Get((Object)("project_wallet"))),0);
 //BA.debugLineNum = 182;BA.debugLine="kvs.Put(\"ProjectWallet\",metadata.Get(\"project_w";
mostCurrent._kvs._put("ProjectWallet",_metadata.Get((Object)("project_wallet")));
 //BA.debugLineNum = 184;BA.debugLine="If kvs.Get(\"ProjectWallet\") = Null Then";
if (mostCurrent._kvs._get("ProjectWallet")== null) { 
 //BA.debugLineNum = 185;BA.debugLine="kvs.Put(\"ProjectWallet\",kvs.Get(\"WalletAddress";
mostCurrent._kvs._put("ProjectWallet",mostCurrent._kvs._get("WalletAddress"));
 //BA.debugLineNum = 186;BA.debugLine="CheckWalletBalance";
_checkwalletbalance();
 }else {
...
_checkwalletbalance();
 ...
 //BA.debugLineNum = 194;BA.debugLine="Dim root As Map = parser.NextObject";
_root = new anywheresoftware.b4a.objects.collections.Map();
_root = _parser.NextObject();
 //BA.debugLineNum = 195;BA.debugLine="Dim strResult As String = root.Get(\"result\")";
_strresult = BA.ObjectToString(_root.Get((Object)("result")));
 //BA.debugLineNum = 197;BA.debugLine="CalculatePercentage(root.Get(\"result\"),kvs.Get(";
_calculatepercentage((double)(BA.ObjectToNumber(_root.Get((Object)("result")))),(double)(BA.ObjectToNumber(mostCurrent._kvs._get("metadataFund"))));
 //BA.debugLineNum = 199;BA.debugLine="If kvs.Get(\"metadataFund\") < root.Get(\"result\")";
if ((double)(BA.ObjectToNumber(mostCurrent._kvs._get("metadataFund")))<(double)(BA.ObjectToNumber(_root.Get((Object)("result"))))) { 
 //BA.debugLineNum = 200;BA.debugLine="lblProjectFund2.Text = \"RM 0\" & NumberFormat2(";
mostCurrent._lblprojectfund2.setText(BA.ObjectToCharSequence("RM 0"+anywheresoftware.b4a.keywords.Common.NumberFormat2(0,(int) (0),(int) (2),(int) (2),anywheresoftware.b4a.keywords.Common.True)));
 ...
 //BA.debugLineNum = 202;BA.debugLine="lblProjectFund2.Text = \"RM \" & NumberFormat2(k";
mostCurrent._lblprojectfund2.setText(BA.ObjectToCharSequence("RM "+anywheresoftware.b4a.keywords.Common.NumberFormat2((double)(BA.ObjectToNumber(mostCurrent._kvs._get("metadataFund")))-(double)(BA.ObjectToNumber(_root.Get((Object)("result")))),(int) (0),(int) (2),(int) (2),anywheresoftware.b4a.keywords.Common.True)));
 ...
 //BA.debugLineNum = 205;BA.debugLine="Log(lblProjectFund2.Text)";
anywheresoftware.b4a.keywords.Common.LogImpl("31966144",mostCurrent._lblprojectfund2.getText(),0);
 }else if((_job._jobname /*String*/ ).equals("JobPostTransaction")) { 
 //BA.debugLineNum = 208;BA.debugLine="Dim root As Map = parser.NextObject";
_root = new anywheresoftware.b4a.objects.collections.Map();
_root = _parser.NextObject();
 //BA.debugLineNum = 209;BA.debugLine="Dim status As Int = root.Get(\"status\")";
_status = (int)(BA.ObjectToNumber(_root.Get((Object)("status"))));
 //BA.debugLineNum = 210;BA.debugLine="Log(root.Get(\"status\"))";
anywheresoftware.b4a.keywords.Common.LogImpl("31966149",BA.ObjectToString(_root.Get((Object)("status"))),0);
 //BA.debugLineNum = 212;BA.debugLine="pnStatus.Visible = True";
mostCurrent._pnstatus.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 213;BA.debugLine="pnConfirmation.Visible = False";
mostCurrent._pnconfirmation.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 216;BA.debugLine="If status = \"200\" Then";
if (_status==(double)(Double.parseDouble("200"))) { 
 //BA.debugLineNum = 218;BA.debugLine="ToastMessageShow(\"Transaction posted successfu";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Transaction posted successfully."),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 219;BA.debugLine="lblStatus.Text = \"Transaction Completed!\" ' Di";
mostCurrent._lblstatus.setText(BA.ObjectToCharSequence("Transaction Completed!"));
 //BA.debugLineNum = 220;BA.debugLine="lblStatus.TextColor = Colors.RGB(5,206,46)";
mostCurrent._lblstatus.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (5),(int) (206),(int) (46)));
 //BA.debugLineNum = 221;BA.debugLine="kvs.Put(\"Status\",\"success\")";
mostCurrent._kvs._put("Status",(Object)("success"));
 }else {
 //BA.debugLineNum = 225;BA.debugLine="ToastMessageShow(\"Failed to post transaction.\"";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Failed to post transaction."),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 226;BA.debugLine="lblStatus.Text = \"Transaction Failed!\" ' Displ";
mostCurrent._lblstatus.setText(BA.ObjectToCharSequence("Transaction Failed!"));
 //BA.debugLineNum = 227;BA.debugLine="lblStatus.TextColor = Colors.RGB(220,14,13)";
mostCurrent._lblstatus.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (220),(int) (14),(int) (13)));
 //BA.debugLineNum = 229;BA.debugLine="kvs.Put(\"Status\",\"failed\")";
mostCurrent._kvs._put("Status",(Object)("failed"));
 };
 }else {
 //BA.debugLineNum = 234;BA.debugLine="Log(\"Error: \" & Job.ErrorMessage)";
anywheresoftware.b4a.keywords.Common.LogImpl("31966173","Error: "+_job._errormessage /*String*/ ,0);
 };
 }else {
 //BA.debugLineNum = 239;BA.debugLine="Log(\"Error: \" & Job.ErrorMessage)";
anywheresoftware.b4a.keywords.Common.LogImpl("31966178","Error: "+_job._errormessage /*String*/ ,0);
 };
 //BA.debugLineNum = 243;BA.debugLine="Job.Release";
_job._release /*String*/ ();
 //BA.debugLineNum = 245;BA.debugLine="End Sub";
return "";
}
public static String  _lblfund_click() throws Exception{
 //BA.debugLineNum = 260;BA.debugLine="Private Sub lblFund_Click";
 //BA.debugLineNum = 262;BA.debugLine="End Sub";
return "";
}
public static String  _lblhistory_click() throws Exception{
 //BA.debugLineNum = 264;BA.debugLine="Private Sub lblHistory_Click";
 //BA.debugLineNum = 266;BA.debugLine="End Sub";
return "";
}
public static String  _lblhome_click() throws Exception{
 //BA.debugLineNum = 256;BA.debugLine="Private Sub lblHome_Click";
...
public static String  _lbluser_click() throws Exception{
 //BA.debugLineNum = 268;BA.debugLine="Private Sub lblUser_Click";
 //BA.debugLineNum = 269;BA.debugLine="StartActivity(\"UserMd\")";
...
anywheresoftware.b4a.objects.collections.Map _data = null;
anywheresoftware.b4a.objects.collections.JSONParser.JSONGenerator _json = null;
 //BA.debugLineNum = 119;BA.debugLine="Sub PostTransaction";
 //BA.debugLineNum = 120;BA.debugLine="Dim JobPostTransaction As HttpJob";
_jobposttransaction = new pdv.milotin.httpjob();
 //BA.debugLineNum = 121;BA.debugLine="JobPostTransaction.Initialize(\"JobPostTransaction";
...
_url = "https://service-testnet.maschain.com/api/token/token-transfer/";
 //BA.debugLineNum = 124;BA.debugLine="Dim data As Map";
_data = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 125;BA.debugLine="data.Initialize";
_data.Initialize();
 //BA.debugLineNum = 126;BA.debugLine="data.Put(\"wallet_address\", kvs.Get(\"WalletAddress";
_data.Put((Object)("wallet_address"),mostCurrent._kvs._get("WalletAddress"));
 //BA.debugLineNum = 127;BA.debugLine="data.Put(\"to\", kvs.Get(\"ProjectWallet\"))";
_data.Put((Object)("to"),mostCurrent._kvs._get("ProjectWallet"));
 //BA.debugLineNum = 128;BA.debugLine="data.Put(\"amount\", kvs.Get(\"DonateAmount\"))";
_data.Put((Object)("amount"),mostCurrent._kvs._get("DonateAmount"));
 //BA.debugLineNum = 129;BA.debugLine="data.Put(\"contract_address\", \"0x5BA886F619b95E2b2";
_data.Put((Object)("contract_address"),(Object)("0x5BA886F619b95E2b2a875503e2FCE58c14027ade"));
 //BA.debugLineNum = 130;BA.debugLine="data.Put(\"callback_url\", \"https://\")";
_data.Put((Object)("callback_url"),(Object)("https://"));
 //BA.debugLineNum = 132;BA.debugLine="Dim json As JSONGenerator";
_json = new anywheresoftware.b4a.objects.collections.JSONParser.JSONGenerator();
 //BA.debugLineNum = 133;BA.debugLine="json.Initialize(data)";
_json.Initialize(_data);
 //BA.debugLineNum = 135;BA.debugLine="JobPostTransaction.PostString(url, json.ToString)";
_jobposttransaction._poststring /*String*/ (_url,_json.ToString());
 //BA.debugLineNum = 136;BA.debugLine="JobPostTransaction.GetRequest.SetContentType(\"app";
_jobposttransaction._getrequest /*anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest*/ ().SetContentType("application/json");
 //BA.debugLineNum = 137;BA.debugLine="JobPostTransaction.GetRequest.SetHeader(\"client_i";
_jobposttransaction._getrequest /*anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest*/ ().SetHeader("client_id",BA.ObjectToString(mostCurrent._kvs._get("client_id")));
 //BA.debugLineNum = 138;BA.debugLine="JobPostTransaction.GetRequest.SetHeader(\"client_s";
