...
anywheresoftware.b4a.keywords.Common.LogImpl("51835023",BA.ObjectToString(mostCurrent._kvs._get("AuditID")),0);
...
RDebugUtils.currentLine=1900550;
 //BA.debugLineNum = 1900550;BA.debugLine="Log(\"AuditTransactionHashID:\" & kvs.Get(\"AuditTra";
anywheresoftware.b4a.keywords.Common.LogImpl("51900550","AuditTransactionHashID:"+BA.ObjectToString(mostCurrent._kvs._get("AuditTransactionHashID")),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("52686983",BA.ObjectToString(mostCurrent._kvs._get("DonateAmount")),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("53014671",anywheresoftware.b4a.keywords.Common.NumberFormat(_percentage,(int) (1),(int) (3)),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("52818053","Donate :"+BA.ObjectToString(mostCurrent._kvs._get("DonateAmount")),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("52097159",_jsonstring,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("52097188",BA.ObjectToString(_metadata.Get((Object)("project"))),0);
RDebugUtils.currentLine=2097189;
 //BA.debugLineNum = 2097189;BA.debugLine="Log(metadata.Get(\"fund\"))";
anywheresoftware.b4a.keywords.Common.LogImpl("52097189",BA.ObjectToString(_metadata.Get((Object)("fund"))),0);
RDebugUtils.currentLine=2097190;
 //BA.debugLineNum = 2097190;BA.debugLine="Log(metadata.Get(\"progress\"))";
anywheresoftware.b4a.keywords.Common.LogImpl("52097190",BA.ObjectToString(_metadata.Get((Object)("progress"))),0);
RDebugUtils.currentLine=2097191;
 //BA.debugLineNum = 2097191;BA.debugLine="Log(metadata.Get(\"status\"))";
anywheresoftware.b4a.keywords.Common.LogImpl("52097191",BA.ObjectToString(_metadata.Get((Object)("status"))),0);
RDebugUtils.currentLine=2097192;
 //BA.debugLineNum = 2097192;BA.debugLine="Log(metadata.Get(\"project_wallet\"))";
anywheresoftware.b4a.keywords.Common.LogImpl("52097192",BA.ObjectToString(_metadata.Get((Object)("project_wallet"))),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("52097216",mostCurrent._lblprojectfund2.getText(),0);
 }else 
...
anywheresoftware.b4a.keywords.Common.LogImpl("52097221",BA.ObjectToString(_root.Get((Object)("status"))),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("52097245","Error: "+_job._errormessage /*String*/ ,0);
 }}}
;
 }else {
RDebugUtils.currentLine=2097250;
 //BA.debugLineNum = 2097250;BA.debugLine="Log(\"Error: \" & Job.ErrorMessage)";
anywheresoftware.b4a.keywords.Common.LogImpl("52097250","Error: "+_job._errormessage /*String*/ ,0);
 };
