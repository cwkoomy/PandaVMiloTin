...
try {
		Debug.PushSubsStack("Activity_KeyPress (homemd) ","homemd",1,homemd.mostCurrent.activityBA,homemd.mostCurrent,276);
...
Debug.ShouldStop(524288);
 BA.debugLineNum = 278;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK Then";
...
try {
		Debug.PushSubsStack("btnAdd_Click (homemd) ","homemd",1,homemd.mostCurrent.activityBA,homemd.mostCurrent,322);
if (RapidSub.canDelegate("btnadd_click")) { return pdv.milotin.homemd.remoteMe.runUserSub(false, "homemd","btnadd_click");}
 BA.debugLineNum = 322;BA.debugLine="Private Sub btnAdd_Click";
Debug.ShouldStop(2);
 BA.debugLineNum = 323;BA.debugLine="StartActivity(\"AddProjectMd\")";
Debug.ShouldStop(4);
...
try {
		Debug.PushSubsStack("clvHome_ItemClick (homemd) ","homemd",1,homemd.mostCurrent.activityBA,homemd.mostCurrent,266);
...
Debug.locals.put("Value", _value);
 BA.debugLineNum = 266;BA.debugLine="Sub clvHome_ItemClick (Index As Int, Value As Obje";
Debug.ShouldStop(512);
 BA.debugLineNum = 268;BA.debugLine="kvs.Put(\"AuditTransactionHash\",Value)";
Debug.ShouldStop(2048);
homemd.mostCurrent._kvs.runVoidMethod ("_put",(Object)(BA.ObjectToString("AuditTransactionHash")),(Object)(_value));
 BA.debugLineNum = 270;BA.debugLine="Log(kvs.Get(\"AuditTransactionHash\"))";
Debug.ShouldStop(8192);
homemd.mostCurrent.__c.runVoidMethod ("LogImpl","41245188",BA.ObjectToString(homemd.mostCurrent._kvs.runMethod(false,"_get",(Object)(RemoteObject.createImmutable("AuditTransactionHash")))),0);
 BA.debugLineNum = 271;BA.debugLine="StartActivity(\"SendFundMd\")";
Debug.ShouldStop(16384);
...
try {
		Debug.PushSubsStack("CreateListItem (homemd) ","homemd",1,homemd.mostCurrent.activityBA,homemd.mostCurrent,220);
...
Debug.ShouldStop(64);
homemd.mostCurrent.__c.runVoidMethod ("LogImpl","41179659",_strprogress,0);
...
if (RemoteObject.solveBoolean("n",_strprogress) || RemoteObject.solveBoolean("=",_strprogress,BA.ObjectToString("null"))) { 
 BA.debugLineNum = 233;BA.debugLine="lblProjectProgress2.TextColor = Colors.RGB(1, 30";
Debug.ShouldStop(256);
...
{ BA.debugLineNum = 235;BA.debugLine="Else If StrProgress <> \"100\" Then";
Debug.ShouldStop(1024);
...
homemd.mostCurrent._lblprojectprogress2.runMethod(true,"setText",BA.ObjectToCharSequence("Fundraising in progress"));
 ...
 BA.debugLineNum = 239;BA.debugLine="lblProjectProgress2.TextColor = Colors.RGB(1, 30";
Debug.ShouldStop(16384);
homemd.mostCurrent._lblprojectprogress2.runMethod(true,"setTextColor",homemd.mostCurrent.__c.getField(false,"Colors").runMethod(true,"RGB",(Object)(BA.numberCast(int.class, 1)),(Object)(BA.numberCast(int.class, 302)),(Object)(BA.numberCast(int.class, 36))));
...
;
 BA.debugLineNum = 255;BA.debugLine="If StrProgress = Null Or StrProgress = \"null\" The";
Debug.ShouldStop(1073741824);
if (RemoteObject.solveBoolean("n",_strprogress) || RemoteObject.solveBoolean("=",_strprogress,BA.ObjectToString("null"))) { 
 BA.debugLineNum = 256;BA.debugLine="StrProgress = \"30\"";
Debug.ShouldStop(-2147483648);
_strprogress = BA.ObjectToString("30");Debug.locals.put("StrProgress", _strprogress);
 BA.debugLineNum = 257;BA.debugLine="cpBar1.Value = StrProgress";
Debug.ShouldStop(1);
homemd.mostCurrent._cpbar1.runClassMethod (pdv.milotin.circularprogressbar.class, "_setvalue" /*RemoteObject*/ ,BA.numberCast(float.class, _strprogress));
 ...
 BA.debugLineNum = 259;BA.debugLine="cpBar1.Value = StrProgress";
Debug.ShouldStop(4);
homemd.mostCurrent._cpbar1.runClassMethod (pdv.milotin.circularprogressbar.class, "_setvalue" /*RemoteObject*/ ,BA.numberCast(float.class, _strprogress));
 };
 BA.debugLineNum = 261;BA.debugLine="cpBar1.Value = StrProgress";
Debug.ShouldStop(16);
homemd.mostCurrent._cpbar1.runClassMethod (pdv.milotin.circularprogressbar.class, "_setvalue" /*RemoteObject*/ ,BA.numberCast(float.class, _strprogress));
 BA.debugLineNum = 262;BA.debugLine="Return p";
Debug.ShouldStop(32);
if (true) return _p;
...
try {
		Debug.PushSubsStack("imgMenu_Click (homemd) ","homemd",1,homemd.mostCurrent.activityBA,homemd.mostCurrent,318);
if (RapidSub.canDelegate("imgmenu_click")) { return pdv.milotin.homemd.remoteMe.runUserSub(false, "homemd","imgmenu_click");}
 BA.debugLineNum = 318;BA.debugLine="Private Sub imgMenu_Click";
Debug.ShouldStop(536870912);
...
Debug.ShouldStop(16777216);
homemd.mostCurrent.__c.runVoidMethod ("LogImpl","41114119",_jsonstring,0);
...
Debug.ShouldStop(16);
homemd.mostCurrent.__c.runVoidMethod ("LogImpl","41114131",RemoteObject.concat(RemoteObject.createImmutable("Number of items in result: "),_numberofitems),0);
...
homemd.mostCurrent.__c.runVoidMethod ("LogImpl","41114147",BA.NumberToString(_totalfund),0);
...
{ BA.debugLineNum = 196;BA.debugLine="Else If Job.JobName = \"JobGetTokenBalance\" Then";
Debug.ShouldStop(8);
...
Debug.ShouldStop(16384);
homemd.mostCurrent.__c.runVoidMethod ("LogImpl","41114173",RemoteObject.concat(RemoteObject.createImmutable("Error: "),_job.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 }}
;
 }else {
 BA.debugLineNum = 212;BA.debugLine="Log(\"Error: \" & Job.ErrorMessage)";
Debug.ShouldStop(524288);
homemd.mostCurrent.__c.runVoidMethod ("LogImpl","41114178",RemoteObject.concat(RemoteObject.createImmutable("Error: "),_job.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 };
...
try {
		Debug.PushSubsStack("lblFund_Click (homemd) ","homemd",1,homemd.mostCurrent.activityBA,homemd.mostCurrent,305);
if (RapidSub.canDelegate("lblfund_click")) { return pdv.milotin.homemd.remoteMe.runUserSub(false, "homemd","lblfund_click");}
 BA.debugLineNum = 305;BA.debugLine="Private Sub lblFund_Click";
Debug.ShouldStop(65536);
 BA.debugLineNum = 306;BA.debugLine="StartActivity(\"FundMd\")";
Debug.ShouldStop(131072);
...
try {
		Debug.PushSubsStack("lblHistory_Click (homemd) ","homemd",1,homemd.mostCurrent.activityBA,homemd.mostCurrent,309);
if (RapidSub.canDelegate("lblhistory_click")) { return pdv.milotin.homemd.remoteMe.runUserSub(false, "homemd","lblhistory_click");}
 BA.debugLineNum = 309;BA.debugLine="Private Sub lblHistory_Click";
Debug.ShouldStop(1048576);
 BA.debugLineNum = 310;BA.debugLine="StartActivity(\"HistoryMd\")";
Debug.ShouldStop(2097152);
...
try {
		Debug.PushSubsStack("lblUser_Click (homemd) ","homemd",1,homemd.mostCurrent.activityBA,homemd.mostCurrent,313);
if (RapidSub.canDelegate("lbluser_click")) { return pdv.milotin.homemd.remoteMe.runUserSub(false, "homemd","lbluser_click");}
 BA.debugLineNum = 313;BA.debugLine="Private Sub lblUser_Click";
Debug.ShouldStop(16777216);
 BA.debugLineNum = 314;BA.debugLine="StartActivity(\"UserMd\")";
Debug.ShouldStop(33554432);
