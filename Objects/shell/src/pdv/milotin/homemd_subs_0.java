...
Debug.ShouldStop(8192);
homemd.mostCurrent.__c.runVoidMethod ("LogImpl","0917508",BA.ObjectToString(homemd.mostCurrent._kvs.runMethod(false,"_get",(Object)(RemoteObject.createImmutable("AuditTransactionHash")))),0);
...
Debug.ShouldStop(64);
homemd.mostCurrent.__c.runVoidMethod ("LogImpl","0851979",_strprogress,0);
...
Debug.ShouldStop(16777216);
homemd.mostCurrent.__c.runVoidMethod ("LogImpl","0786439",_jsonstring,0);
...
Debug.ShouldStop(16);
homemd.mostCurrent.__c.runVoidMethod ("LogImpl","0786451",RemoteObject.concat(RemoteObject.createImmutable("Number of items in result: "),_numberofitems),0);
...
homemd.mostCurrent.__c.runVoidMethod ("LogImpl","0786467",BA.NumberToString(_totalfund),0);
...
Debug.ShouldStop(16384);
homemd.mostCurrent.__c.runVoidMethod ("LogImpl","0786493",RemoteObject.concat(RemoteObject.createImmutable("Error: "),_job.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 }}
;
 }else {
 BA.debugLineNum = 212;BA.debugLine="Log(\"Error: \" & Job.ErrorMessage)";
Debug.ShouldStop(524288);
homemd.mostCurrent.__c.runVoidMethod ("LogImpl","0786498",RemoteObject.concat(RemoteObject.createImmutable("Error: "),_job.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 };
