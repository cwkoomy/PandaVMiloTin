...
sendfundmd.mostCurrent.__c.runVoidMethod ("LogImpl","01507343",BA.ObjectToString(sendfundmd.mostCurrent._kvs.runMethod(false,"_get",(Object)(RemoteObject.createImmutable("AuditID")))),0);
...
Debug.ShouldStop(1024);
sendfundmd.mostCurrent.__c.runVoidMethod ("LogImpl","02359303",BA.ObjectToString(sendfundmd.mostCurrent._kvs.runMethod(false,"_get",(Object)(RemoteObject.createImmutable("DonateAmount")))),0);
...
Debug.ShouldStop(33554432);
sendfundmd.mostCurrent.__c.runVoidMethod ("LogImpl","02686991",sendfundmd.mostCurrent.__c.runMethod(true,"NumberFormat",(Object)(_percentage),(Object)(BA.numberCast(int.class, 1)),(Object)(BA.numberCast(int.class, 3))),0);
...
Debug.ShouldStop(33554432);
sendfundmd.mostCurrent.__c.runVoidMethod ("LogImpl","01572870",RemoteObject.concat(RemoteObject.createImmutable("HASH:"),sendfundmd.mostCurrent._kvs.runMethod(false,"_get",(Object)(RemoteObject.createImmutable("AuditTransactionHash")))),0);
...
Debug.ShouldStop(16777216);
sendfundmd.mostCurrent.__c.runVoidMethod ("LogImpl","02490373",RemoteObject.concat(RemoteObject.createImmutable("Donate :"),sendfundmd.mostCurrent._kvs.runMethod(false,"_get",(Object)(RemoteObject.createImmutable("DonateAmount")))),0);
...
Debug.ShouldStop(1048576);
sendfundmd.mostCurrent.__c.runVoidMethod ("LogImpl","01769479",_jsonstring,0);
...
Debug.ShouldStop(131072);
sendfundmd.mostCurrent.__c.runVoidMethod ("LogImpl","01769508",BA.ObjectToString(_metadata.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("project"))))),0);
 BA.debugLineNum = 179;BA.debugLine="Log(metadata.Get(\"fund\"))";
Debug.ShouldStop(262144);
sendfundmd.mostCurrent.__c.runVoidMethod ("LogImpl","01769509",BA.ObjectToString(_metadata.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("fund"))))),0);
 BA.debugLineNum = 180;BA.debugLine="Log(metadata.Get(\"progress\"))";
Debug.ShouldStop(524288);
sendfundmd.mostCurrent.__c.runVoidMethod ("LogImpl","01769510",BA.ObjectToString(_metadata.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("progress"))))),0);
 BA.debugLineNum = 181;BA.debugLine="Log(metadata.Get(\"status\"))";
Debug.ShouldStop(1048576);
sendfundmd.mostCurrent.__c.runVoidMethod ("LogImpl","01769511",BA.ObjectToString(_metadata.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("status"))))),0);
 BA.debugLineNum = 182;BA.debugLine="Log(metadata.Get(\"project_wallet\"))";
Debug.ShouldStop(2097152);
sendfundmd.mostCurrent.__c.runVoidMethod ("LogImpl","01769512",BA.ObjectToString(_metadata.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("project_wallet"))))),0);
...
Debug.ShouldStop(8192);
sendfundmd.mostCurrent.__c.runVoidMethod ("LogImpl","01769536",sendfundmd.mostCurrent._lblprojectfund2.runMethod(true,"getText"),0);
 }else 
...
Debug.ShouldStop(262144);
sendfundmd.mostCurrent.__c.runVoidMethod ("LogImpl","01769541",BA.ObjectToString(_root.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("status"))))),0);
...
Debug.ShouldStop(1024);
sendfundmd.mostCurrent.__c.runVoidMethod ("LogImpl","01769565",RemoteObject.concat(RemoteObject.createImmutable("Error: "),_job.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 }}}
;
 }else {
 BA.debugLineNum = 240;BA.debugLine="Log(\"Error: \" & Job.ErrorMessage)";
Debug.ShouldStop(32768);
sendfundmd.mostCurrent.__c.runVoidMethod ("LogImpl","01769570",RemoteObject.concat(RemoteObject.createImmutable("Error: "),_job.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 };
