...
try {
		Debug.PushSubsStack("Activity_Create (fundmd) ","fundmd",5,fundmd.mostCurrent.activityBA,fundmd.mostCurrent,50);
...
Debug.ShouldStop(131072);
 BA.debugLineNum = 52;BA.debugLine="Activity.LoadLayout(\"FundLy\")";
...
fundmd.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("FundLy")),fundmd.mostCurrent.activityBA);
 BA.debugLineNum = 54;BA.debugLine="shared = rp.GetSafeDirDefaultExternal(\"\")";
...
fundmd.mostCurrent._shared = fundmd.mostCurrent._rp.runMethod(true,"GetSafeDirDefaultExternal",(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 55;BA.debugLine="kvs.Initialize(shared, \"Userdatastore\")";
...
fundmd.mostCurrent._kvs.runVoidMethod ("_initialize",fundmd.processBA,(Object)(fundmd.mostCurrent._shared),(Object)(RemoteObject.createImmutable("Userdatastore")));
 BA.debugLineNum = 57;BA.debugLine="If File.Exists(File.DirDefaultExternal ,\"db.db\")";
...
if (RemoteObject.solveBoolean("=",fundmd.mostCurrent.__c.getField(false,"File").runMethod(true,"Exists",(Object)(fundmd.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirDefaultExternal")),(Object)(RemoteObject.createImmutable("db.db"))),fundmd.mostCurrent.__c.getField(true,"False"))) { 
 BA.debugLineNum = 58;BA.debugLine="File.Copy(File.DirAssets,\"db.db\",File.DirDefault";
...
if (RemoteObject.solveBoolean("=",fundmd.mostCurrent._sql1.runMethod(true,"IsInitialized"),fundmd.mostCurrent.__c.getField(true,"False"))) { 
 BA.debugLineNum = 62;BA.debugLine="SQL1.Initialize(File.DirDefaultExternal, \"db.db\"";
...
fundmd.mostCurrent._sql1.runVoidMethod ("Initialize",(Object)(fundmd.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirDefaultExternal")),(Object)(BA.ObjectToString("db.db")),(Object)(fundmd.mostCurrent.__c.getField(true,"False")));
 ...
 BA.debugLineNum = 65;BA.debugLine="GetAudit";
Debug.ShouldStop(1);
_getaudit();
...
try {
		Debug.PushSubsStack("Activity_KeyPress (fundmd) ","fundmd",5,fundmd.mostCurrent.activityBA,fundmd.mostCurrent,218);
...
if (RemoteObject.solveBoolean("=",_keycode,BA.numberCast(double.class, fundmd.mostCurrent.__c.getField(false,"KeyCodes").getField(true,"KEYCODE_BACK")))) { 
 BA.debugLineNum = 221;BA.debugLine="kvs.Put(\"ProjectWallet\",\"\")";
Debug.ShouldStop(268435456);
...
try {
		Debug.PushSubsStack("Activity_Pause (fundmd) ","fundmd",5,fundmd.mostCurrent.activityBA,fundmd.mostCurrent,72);
...
try {
		Debug.PushSubsStack("Activity_Resume (fundmd) ","fundmd",5,fundmd.mostCurrent.activityBA,fundmd.mostCurrent,68);
...
Debug.ShouldStop(8);
 BA.debugLineNum = 69;BA.debugLine="GetAudit";
Debug.ShouldStop(16);
_getaudit();
...
try {
		Debug.PushSubsStack("clvFundList_ItemClick (fundmd) ","fundmd",5,fundmd.mostCurrent.activityBA,fundmd.mostCurrent,208);
...
Debug.locals.put("Value", _value);
 BA.debugLineNum = 208;BA.debugLine="Sub clvFundList_ItemClick (Index As Int, Value As";
Debug.ShouldStop(32768);
 BA.debugLineNum = 210;BA.debugLine="kvs.Put(\"AuditTransactionHashID\",Value)";
Debug.ShouldStop(131072);
fundmd.mostCurrent._kvs.runVoidMethod ("_put",(Object)(BA.ObjectToString("AuditTransactionHashID")),(Object)(_value));
 BA.debugLineNum = 212;BA.debugLine="Log(kvs.Get(\"AuditTransactionHashID\"))";
Debug.ShouldStop(524288);
fundmd.mostCurrent.__c.runVoidMethod ("LogImpl","55111812",BA.ObjectToString(fundmd.mostCurrent._kvs.runMethod(false,"_get",(Object)(RemoteObject.createImmutable("AuditTransactionHashID")))),0);
 BA.debugLineNum = 213;BA.debugLine="StartActivity(\"SendFundMd\")";
Debug.ShouldStop(1048576);
fundmd.mostCurrent.__c.runVoidMethod ("StartActivity",fundmd.processBA,(Object)((RemoteObject.createImmutable("SendFundMd"))));
...
try {
		Debug.PushSubsStack("CreateListItem (fundmd) ","fundmd",5,fundmd.mostCurrent.activityBA,fundmd.mostCurrent,162);
...
Debug.locals.put("Height", _height);
 BA.debugLineNum = 162;BA.debugLine="Sub CreateListItem(strID As String, strProject As";
Debug.ShouldStop(2);
...
_p.runVoidMethod ("Initialize",fundmd.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 167;BA.debugLine="Activity.AddView(p, 0, 0, 96%x, 100%y)";
Debug.ShouldStop(64);
fundmd.mostCurrent._activity.runVoidMethod ("AddView",(Object)((_p.getObject())),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(fundmd.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 96)),fundmd.mostCurrent.activityBA)),(Object)(fundmd.mostCurrent.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 100)),fundmd.mostCurrent.activityBA)));
 BA.debugLineNum = 168;BA.debugLine="p.LoadLayout(\"ListViewLy3\")";
Debug.ShouldStop(128);
_p.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("ListViewLy3")),fundmd.mostCurrent.activityBA);
 BA.debugLineNum = 169;BA.debugLine="p.RemoveView";
Debug.ShouldStop(256);
_p.runVoidMethod ("RemoveView");
 BA.debugLineNum = 171;BA.debugLine="lblProjectTitle2.Text = strProject";
Debug.ShouldStop(1024);
fundmd.mostCurrent._lblprojecttitle2.runMethod(true,"setText",BA.ObjectToCharSequence(_strproject));
 BA.debugLineNum = 172;BA.debugLine="lblProjectFund2.Text = \"RM \" & NumberFormat2(strF";
...
fundmd.mostCurrent._lblprojectfund2.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("RM "),fundmd.mostCurrent.__c.runMethod(true,"NumberFormat2",(Object)(BA.numberCast(double.class, _strfund)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 2)),(Object)(BA.numberCast(int.class, 2)),(Object)(fundmd.mostCurrent.__c.getField(true,"True"))))));
 BA.debugLineNum = 173;BA.debugLine="Log(StrProgress)";
Debug.ShouldStop(4096);
fundmd.mostCurrent.__c.runVoidMethod ("LogImpl","55046283",_strprogress,0);
 BA.debugLineNum = 174;BA.debugLine="If StrProgress = Null Or StrProgress = \"null\" The";
Debug.ShouldStop(8192);
if (RemoteObject.solveBoolean("n",_strprogress) || RemoteObject.solveBoolean("=",_strprogress,BA.ObjectToString("null"))) { 
 BA.debugLineNum = 175;BA.debugLine="lblProjectProgress2.TextColor = Colors.RGB(1, 30";
...
fundmd.mostCurrent._lblprojectprogress2.runMethod(true,"setTextColor",fundmd.mostCurrent.__c.getField(false,"Colors").runMethod(true,"RGB",(Object)(BA.numberCast(int.class, 1)),(Object)(BA.numberCast(int.class, 302)),(Object)(BA.numberCast(int.class, 36))));
 BA.debugLineNum = 176;BA.debugLine="lblProjectProgress2.Text = \"Fundraising Complete";
Debug.ShouldStop(32768);
fundmd.mostCurrent._lblprojectprogress2.runMethod(true,"setText",BA.ObjectToCharSequence("Fundraising Completed"));
 }else 
{ BA.debugLineNum = 177;BA.debugLine="Else If StrProgress <> \"100\" Then";
Debug.ShouldStop(65536);
if (RemoteObject.solveBoolean("!",_strprogress,BA.ObjectToString("100"))) { 
 BA.debugLineNum = 178;BA.debugLine="lblProjectProgress2.TextColor = Colors.RGB(254,";
Debug.ShouldStop(131072);
fundmd.mostCurrent._lblprojectprogress2.runMethod(true,"setTextColor",fundmd.mostCurrent.__c.getField(false,"Colors").runMethod(true,"RGB",(Object)(BA.numberCast(int.class, 254)),(Object)(BA.numberCast(int.class, 171)),(Object)(BA.numberCast(int.class, 43))));
 BA.debugLineNum = 179;BA.debugLine="lblProjectProgress2.Text = \"Fundraising in progr";
Debug.ShouldStop(262144);
fundmd.mostCurrent._lblprojectprogress2.runMethod(true,"setText",BA.ObjectToCharSequence("Fundraising in progress"));
 }else {
 BA.debugLineNum = 181;BA.debugLine="lblProjectProgress2.TextColor = Colors.RGB(1, 30";
Debug.ShouldStop(1048576);
fundmd.mostCurrent._lblprojectprogress2.runMethod(true,"setTextColor",fundmd.mostCurrent.__c.getField(false,"Colors").runMethod(true,"RGB",(Object)(BA.numberCast(int.class, 1)),(Object)(BA.numberCast(int.class, 302)),(Object)(BA.numberCast(int.class, 36))));
 BA.debugLineNum = 182;BA.debugLine="lblProjectProgress2.Text = \"Fundraising Complete";
Debug.ShouldStop(2097152);
fundmd.mostCurrent._lblprojectprogress2.runMethod(true,"setText",BA.ObjectToCharSequence("Fundraising Completed"));
 }}
;
...
try {
		Debug.PushSubsStack("GetAudit (fundmd) ","fundmd",5,fundmd.mostCurrent.activityBA,fundmd.mostCurrent,76);
...
RemoteObject _url = RemoteObject.createImmutable("");
 BA.debugLineNum = 76;BA.debugLine="Sub GetAudit";
Debug.ShouldStop(2048);
 BA.debugLineNum = 78;BA.debugLine="Dim JobGetAudit As HttpJob";
Debug.ShouldStop(8192);
_jobgetaudit = RemoteObject.createNew ("pdv.milotin.httpjob");Debug.locals.put("JobGetAudit", _jobgetaudit);
 BA.debugLineNum = 79;BA.debugLine="JobGetAudit.Initialize(\"JobGetAudit\", Me)";
Debug.ShouldStop(16384);
_jobgetaudit.runClassMethod (pdv.milotin.httpjob.class, "_initialize" /*RemoteObject*/ ,fundmd.processBA,(Object)(BA.ObjectToString("JobGetAudit")),(Object)(fundmd.getObject()));
 BA.debugLineNum = 81;BA.debugLine="Dim url As String = \"https://service-testnet.masc";
Debug.ShouldStop(65536);
_url = BA.ObjectToString("https://service-testnet.maschain.com/api/audit/audit");Debug.locals.put("url", _url);Debug.locals.put("url", _url);
 BA.debugLineNum = 82;BA.debugLine="JobGetAudit.Download(url)";
Debug.ShouldStop(131072);
_jobgetaudit.runClassMethod (pdv.milotin.httpjob.class, "_download" /*RemoteObject*/ ,(Object)(_url));
 BA.debugLineNum = 83;BA.debugLine="JobGetAudit.GetRequest.SetHeader(\"client_id\", kvs";
Debug.ShouldStop(262144);
_jobgetaudit.runClassMethod (pdv.milotin.httpjob.class, "_getrequest" /*RemoteObject*/ ).runVoidMethod ("SetHeader",(Object)(BA.ObjectToString("client_id")),(Object)(BA.ObjectToString(fundmd.mostCurrent._kvs.runMethod(false,"_get",(Object)(RemoteObject.createImmutable("client_id"))))));
 BA.debugLineNum = 84;BA.debugLine="JobGetAudit.GetRequest.SetHeader(\"client_secret\",";
Debug.ShouldStop(524288);
...
try {
		Debug.PushSubsStack("imgBack_Click (fundmd) ","fundmd",5,fundmd.mostCurrent.activityBA,fundmd.mostCurrent,247);
if (RapidSub.canDelegate("imgback_click")) { return pdv.milotin.fundmd.remoteMe.runUserSub(false, "fundmd","imgback_click");}
 BA.debugLineNum = 247;BA.debugLine="Private Sub imgBack_Click";
Debug.ShouldStop(4194304);
...
try {
		Debug.PushSubsStack("JobDone (fundmd) ","fundmd",5,fundmd.mostCurrent.activityBA,fundmd.mostCurrent,88);
...
if (_job.getField(true,"_success" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 94;BA.debugLine="Dim jsonString As String = Job.GetString";
Debug.ShouldStop(536870912);
_jsonstring = _job.runClassMethod (pdv.milotin.httpjob.class, "_getstring" /*RemoteObject*/ );Debug.locals.put("jsonString", _jsonstring);Debug.locals.put("jsonString", _jsonstring);
 BA.debugLineNum = 95;BA.debugLine="Log(jsonString)";
Debug.ShouldStop(1073741824);
fundmd.mostCurrent.__c.runVoidMethod ("LogImpl","54980743",_jsonstring,0);
 BA.debugLineNum = 97;BA.debugLine="Dim parser As JSONParser";
Debug.ShouldStop(1);
_parser = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.JSONParser");Debug.locals.put("parser", _parser);
 BA.debugLineNum = 98;BA.debugLine="parser.Initialize(jsonString)";
Debug.ShouldStop(2);
_parser.runVoidMethod ("Initialize",(Object)(_jsonstring));
 BA.debugLineNum = 100;BA.debugLine="If Job.JobName = \"JobGetAudit\" Then";
Debug.ShouldStop(8);
if (RemoteObject.solveBoolean("=",_job.getField(true,"_jobname" /*RemoteObject*/ ),BA.ObjectToString("JobGetAudit"))) { 
 BA.debugLineNum = 101;BA.debugLine="clvFundList.Clear";
Debug.ShouldStop(16);
...
_root = _parser.runMethod(false,"NextObject");Debug.locals.put("root", _root);Debug.locals.put("root", _root);
 BA.debugLineNum = 105;BA.debugLine="Dim results As List = root.Get(\"result\")";
Debug.ShouldStop(256);
...
_results = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _root.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("result")))));Debug.locals.put("results", _results);Debug.locals.put("results", _results);
 BA.debugLineNum = 106;BA.debugLine="Dim numberOfItems As Int = results.Size";
Debug.ShouldStop(512);
_numberofitems = _results.runMethod(true,"getSize");Debug.locals.put("numberOfItems", _numberofitems);Debug.locals.put("numberOfItems", _numberofitems);
 BA.debugLineNum = 107;BA.debugLine="Log(\"Number of items in result: \" & numberOfIte";
Debug.ShouldStop(1024);
fundmd.mostCurrent.__c.runVoidMethod ("LogImpl","54980755",RemoteObject.concat(RemoteObject.createImmutable("Number of items in result: "),_numberofitems),0);
 BA.debugLineNum = 108;BA.debugLine="Dim totalFund As Double = 0 ' Initialize total";
Debug.ShouldStop(2048);
_totalfund = BA.numberCast(double.class, 0);Debug.locals.put("totalFund", _totalfund);Debug.locals.put("totalFund", _totalfund);
 BA.debugLineNum = 109;BA.debugLine="For Each result As Map In results";
Debug.ShouldStop(4096);
...
Debug.locals.put("result", _result);
 BA.debugLineNum = 111;BA.debugLine="Dim metadataString As String = result.Get(\"met";
Debug.ShouldStop(16384);
_metadatastring = BA.ObjectToString(_result.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("metadata")))));Debug.locals.put("metadataString", _metadatastring);Debug.locals.put("metadataString", _metadatastring);
 BA.debugLineNum = 114;BA.debugLine="Dim metadataParser As JSONParser";
Debug.ShouldStop(131072);
_metadataparser = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.JSONParser");Debug.locals.put("metadataParser", _metadataparser);
 BA.debugLineNum = 115;BA.debugLine="metadataParser.Initialize(metadataString)";
Debug.ShouldStop(262144);
_metadataparser.runVoidMethod ("Initialize",(Object)(_metadatastring));
 BA.debugLineNum = 116;BA.debugLine="Dim metadata As Map = metadataParser.NextObjec";
Debug.ShouldStop(524288);
...
_metadata = _metadataparser.runMethod(false,"NextObject");Debug.locals.put("metadata", _metadata);Debug.locals.put("metadata", _metadata);
 BA.debugLineNum = 117;BA.debugLine="Dim fund As Double";
Debug.ShouldStop(1048576);
_fund = RemoteObject.createImmutable(0);Debug.locals.put("fund", _fund);
 BA.debugLineNum = 118;BA.debugLine="fund = metadata.Get(\"fund\")";
Debug.ShouldStop(2097152);
...
_gd.runVoidMethod ("Initialize",(Object)(BA.getEnumFromString(BA.getDeviceClass("android.graphics.drawable.GradientDrawable.Orientation"),"TR_BL")),(Object)(RemoteObject.createNewArray("int",new int[] {2},new Object[] {fundmd.mostCurrent.__c.getField(false,"Colors").runMethod(true,"ARGB",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 255)),(Object)(BA.numberCast(int.class, 255)),(Object)(BA.numberCast(int.class, 255))),fundmd.mostCurrent.__c.getField(false,"Colors").runMethod(true,"ARGB",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 255)),(Object)(BA.numberCast(int.class, 255)),(Object)(BA.numberCast(int.class, 255)))})));
 BA.debugLineNum = 128;BA.debugLine="gd.CornerRadius = 20dip ' Adjust corner radius";
...
_gd.runVoidMethod ("setCornerRadius",BA.numberCast(float.class, fundmd.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 20)))));
 BA.debugLineNum = 130;BA.debugLine="clvFundList.AsView.Background = gd";
Debug.ShouldStop(2);
...
{ BA.debugLineNum = 138;BA.debugLine="Else If Job.JobName = \"JobGetTokenBalance\" Then";
Debug.ShouldStop(512);
...
_root = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_root = _parser.runMethod(false,"NextObject");Debug.locals.put("root", _root);Debug.locals.put("root", _root);
 BA.debugLineNum = 140;BA.debugLine="Dim strAmount As String = root.Get(\"result\")";
Debug.ShouldStop(2048);
_stramount = BA.ObjectToString(_root.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("result")))));Debug.locals.put("strAmount", _stramount);Debug.locals.put("strAmount", _stramount);
 BA.debugLineNum = 143;BA.debugLine="Dim amount As Double";
Debug.ShouldStop(16384);
_amount = RemoteObject.createImmutable(0);Debug.locals.put("amount", _amount);
 BA.debugLineNum = 144;BA.debugLine="amount = strAmount";
Debug.ShouldStop(32768);
_amount = BA.numberCast(double.class, _stramount);Debug.locals.put("amount", _amount);
 }else {
 BA.debugLineNum = 149;BA.debugLine="Log(\"Error: \" & Job.ErrorMessage)";
Debug.ShouldStop(1048576);
fundmd.mostCurrent.__c.runVoidMethod ("LogImpl","54980797",RemoteObject.concat(RemoteObject.createImmutable("Error: "),_job.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 }}
;
 }else {
 BA.debugLineNum = 154;BA.debugLine="Log(\"Error: \" & Job.ErrorMessage)";
Debug.ShouldStop(33554432);
fundmd.mostCurrent.__c.runVoidMethod ("LogImpl","54980802",RemoteObject.concat(RemoteObject.createImmutable("Error: "),_job.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 };
...
try {
		Debug.PushSubsStack("lblFund_Click (fundmd) ","fundmd",5,fundmd.mostCurrent.activityBA,fundmd.mostCurrent,233);
if (RapidSub.canDelegate("lblfund_click")) { return pdv.milotin.fundmd.remoteMe.runUserSub(false, "fundmd","lblfund_click");}
 BA.debugLineNum = 233;BA.debugLine="Private Sub lblFund_Click";
Debug.ShouldStop(256);
...
try {
		Debug.PushSubsStack("lblHistory_Click (fundmd) ","fundmd",5,fundmd.mostCurrent.activityBA,fundmd.mostCurrent,237);
if (RapidSub.canDelegate("lblhistory_click")) { return pdv.milotin.fundmd.remoteMe.runUserSub(false, "fundmd","lblhistory_click");}
 BA.debugLineNum = 237;BA.debugLine="Private Sub lblHistory_Click";
Debug.ShouldStop(4096);
 BA.debugLineNum = 238;BA.debugLine="StartActivity(\"HistoryMd\")";
Debug.ShouldStop(8192);
...
try {
		Debug.PushSubsStack("lblHome_Click (fundmd) ","fundmd",5,fundmd.mostCurrent.activityBA,fundmd.mostCurrent,229);
if (RapidSub.canDelegate("lblhome_click")) { return pdv.milotin.fundmd.remoteMe.runUserSub(false, "fundmd","lblhome_click");}
 BA.debugLineNum = 229;BA.debugLine="Private Sub lblHome_Click";
Debug.ShouldStop(16);
...
try {
		Debug.PushSubsStack("lblUser_Click (fundmd) ","fundmd",5,fundmd.mostCurrent.activityBA,fundmd.mostCurrent,242);
if (RapidSub.canDelegate("lbluser_click")) { return pdv.milotin.fundmd.remoteMe.runUserSub(false, "fundmd","lbluser_click");}
 BA.debugLineNum = 242;BA.debugLine="Private Sub lblUser_Click";
Debug.ShouldStop(131072);
 BA.debugLineNum = 243;BA.debugLine="StartActivity(\"UserMd\")";
Debug.ShouldStop(262144);
