...
Debug.ShouldStop(2097152);
fundmd.mostCurrent.__c.runVoidMethod ("LogImpl","04784132",BA.ObjectToString(fundmd.mostCurrent._kvs.runMethod(false,"_get",(Object)(RemoteObject.createImmutable("AuditTransactionHash")))),0);
...
fundmd.mostCurrent.__c.runVoidMethod ("LogImpl","04718603",_strprogress,0);
...
Debug.ShouldStop(1);
fundmd.mostCurrent.__c.runVoidMethod ("LogImpl","04653063",_jsonstring,0);
...
Debug.ShouldStop(4096);
fundmd.mostCurrent.__c.runVoidMethod ("LogImpl","04653075",RemoteObject.concat(RemoteObject.createImmutable("Number of items in result: "),_numberofitems),0);
...
Debug.ShouldStop(268435456);
fundmd.mostCurrent.__c.runVoidMethod ("LogImpl","04653091",BA.NumberToString(_totalfund),0);
...
Debug.ShouldStop(4194304);
fundmd.mostCurrent.__c.runVoidMethod ("LogImpl","04653117",RemoteObject.concat(RemoteObject.createImmutable("Error: "),_job.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 }}
;
 }else {
 BA.debugLineNum = 156;BA.debugLine="Log(\"Error: \" & Job.ErrorMessage)";
Debug.ShouldStop(134217728);
fundmd.mostCurrent.__c.runVoidMethod ("LogImpl","04653122",RemoteObject.concat(RemoteObject.createImmutable("Error: "),_job.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 };
