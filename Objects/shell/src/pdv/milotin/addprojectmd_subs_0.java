...
try {
		Debug.PushSubsStack("Activity_Pause (addprojectmd) ","addprojectmd",6,addprojectmd.mostCurrent.activityBA,addprojectmd.mostCurrent,82);
...
try {
		Debug.PushSubsStack("Activity_Resume (addprojectmd) ","addprojectmd",6,addprojectmd.mostCurrent.activityBA,addprojectmd.mostCurrent,78);
...
try {
		Debug.PushSubsStack("btnClose_Click (addprojectmd) ","addprojectmd",6,addprojectmd.mostCurrent.activityBA,addprojectmd.mostCurrent,171);
...
try {
		Debug.PushSubsStack("btnProjectSubmit_Click (addprojectmd) ","addprojectmd",6,addprojectmd.mostCurrent.activityBA,addprojectmd.mostCurrent,166);
...
try {
		Debug.PushSubsStack("JobDone (addprojectmd) ","addprojectmd",6,addprojectmd.mostCurrent.activityBA,addprojectmd.mostCurrent,117);
...
try {
		Debug.PushSubsStack("PostAudit (addprojectmd) ","addprojectmd",6,addprojectmd.mostCurrent.activityBA,addprojectmd.mostCurrent,86);
