...
try {
		Debug.PushSubsStack("AnimateValueTo (circularprogressbar) ","circularprogressbar",8,__ref.getField(false, "ba"),__ref,94);
...
try {
		Debug.PushSubsStack("Base_Resize (circularprogressbar) ","circularprogressbar",8,__ref.getField(false, "ba"),__ref,74);
...
try {
		Debug.PushSubsStack("DesignerCreateView (circularprogressbar) ","circularprogressbar",8,__ref.getField(false, "ba"),__ref,33);
...
try {
		Debug.PushSubsStack("DrawValue (circularprogressbar) ","circularprogressbar",8,__ref.getField(false, "ba"),__ref,131);
...
try {
		Debug.PushSubsStack("getValue (circularprogressbar) ","circularprogressbar",8,__ref.getField(false, "ba"),__ref,90);
...
try {
		Debug.PushSubsStack("Initialize (circularprogressbar) ","circularprogressbar",8,__ref.getField(false, "ba"),__ref,28);
...
try {
		Debug.PushSubsStack("ResetBC (circularprogressbar) ","circularprogressbar",8,__ref.getField(false, "ba"),__ref,57);
...
try {
		Debug.PushSubsStack("setValue (circularprogressbar) ","circularprogressbar",8,__ref.getField(false, "ba"),__ref,86);
...
try {
		Debug.PushSubsStack("ValueFromTimeEaseInOut (circularprogressbar) ","circularprogressbar",8,__ref.getField(false, "ba"),__ref,112);
