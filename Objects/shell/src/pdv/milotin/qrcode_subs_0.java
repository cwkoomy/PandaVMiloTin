...
try {
		Debug.PushSubsStack("drawQRCode (qrcode) ","qrcode",10,__ref.getField(false, "ba"),__ref,15);
...
try {
		Debug.PushSubsStack("Initialize (qrcode) ","qrcode",10,__ref.getField(false, "ba"),__ref,9);
