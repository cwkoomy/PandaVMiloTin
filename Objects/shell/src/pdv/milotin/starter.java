...
public static pdv.milotin.httputils2service _httputils2service = null;
  public Object[] GetGlobals() {
		return new Object[] {"AddProjectMd",Debug.moduleToString(pdv.milotin.addprojectmd.class),"DateUtils",starter.mostCurrent._dateutils,"FundMd",Debug.moduleToString(pdv.milotin.fundmd.class),"HistoryMd",Debug.moduleToString(pdv.milotin.historymd.class),"HomeMd",Debug.moduleToString(pdv.milotin.homemd.class),"HttpUtils2Service",Debug.moduleToString(pdv.milotin.httputils2service.class),"Main",Debug.moduleToString(pdv.milotin.main.class),"SendFundMd",Debug.moduleToString(pdv.milotin.sendfundmd.class),"Service",starter.mostCurrent._service,"UserMd",Debug.moduleToString(pdv.milotin.usermd.class)};
}
}