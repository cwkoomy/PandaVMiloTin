...
public static RemoteObject _btnviewfund = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
public static RemoteObject _btnaddallocate = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
