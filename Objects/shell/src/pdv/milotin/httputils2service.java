...
public static pdv.milotin.starter _starter = null;
  public Object[] GetGlobals() {
		return new Object[] {"AddProjectMd",Debug.moduleToString(pdv.milotin.addprojectmd.class),"DateUtils",httputils2service.mostCurrent._dateutils,"FundMd",Debug.moduleToString(pdv.milotin.fundmd.class),"hc",httputils2service._hc,"HistoryMd",Debug.moduleToString(pdv.milotin.historymd.class),"HomeMd",Debug.moduleToString(pdv.milotin.homemd.class),"Main",Debug.moduleToString(pdv.milotin.main.class),"Receiver",httputils2service.mostCurrent._receiver,"SendFundMd",Debug.moduleToString(pdv.milotin.sendfundmd.class),"Starter",Debug.moduleToString(pdv.milotin.starter.class),"taskCounter",httputils2service._taskcounter,"TaskIdToJob",httputils2service._taskidtojob,"TempFolder",httputils2service._tempfolder,"UserMd",Debug.moduleToString(pdv.milotin.usermd.class)};
}
}